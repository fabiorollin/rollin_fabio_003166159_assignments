...
import UserInterface.WorkAreas.AdminRole.ManageNUIDWorkResp.ManageNUIDJPanel;
import UserInterface.WorkAreas.AdminRole.MyProfileWorkResp.AdminMyProfileJPanel;
...
public class AdminRoleWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public AdminRoleWorkAreaJPanel(Business b, EmployeeProfile ep, UserAccount ua, JPanel clp) {

        business = b;
        this.adminProfile = ep;
        this.adminAccount = ua;
    ...
    private void jButton6IdentifyEventsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6IdentifyEventsActionPerformed
        AdminMyProfileJPanel panel = new AdminMyProfileJPanel(business, adminProfile, adminAccount, CardSequencePanel);
        CardSequencePanel.add("AdminMyProfileJPanel", panel);
        ((java.awt.CardLayout) CardSequencePanel.getLayout()).next(CardSequencePanel);
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        CardSequencePanel.add("ManageFacultyJPanel", panel);
        ((java.awt.CardLayout) CardSequencePanel.getLayout()).next(CardSequencePanel);
